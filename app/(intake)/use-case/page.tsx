...
export default function UseCasePage() {
  ...
  const [value, setValue] = useState<UseCase | null>(null);
    ...
    <div className="flex flex-col gap-10 pb-16">
      ...
      <div className="pt-2">
        <button
          ...
          onClick={() => {
            if (!ready) return;
            // TODO: persist to intake store once Q2 lands. For now, route
            // straight to the JPMC demo results so the end-to-end POC
            // loop stays visible.
